...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    MO(1),          CW_TOGG,        KC_LEFT,        KC_RIGHT,       SC_LCPO,   TT(1),                                                                                                   TT(2),  SC_RCPC,  KC_UP,          KC_DOWN,        KC_LBRC,        KC_RBRC,        
    KC_BSPC,        SC_LAPO,    SC_LSPO,                  SC_RSPC, SC_RAPC,    KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          QK_BOOT,                                 KC_TRANSPARENT, KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_UNDS,        
    SGUI(KC_M), RGB_MODE_FORWARD,RGB_VAD,        RGB_VAI,        TOGGLE_LAYER_COLOR,KC_PIPE,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_UP,          KC_LCBR,        KC_RCBR,        KC_LBRC,        KC_RBRC,        KC_F12,         
    ...
    KC_TRANSPARENT, KC_COMMA,       HSV_0_245_245,  HSV_74_255_206, HSV_152_255_255,KC_LEFT_CTRL,                                                                                                   KC_RIGHT_CTRL, KC_RIGHT_CTRL,  A(KC_LEFT), A(KC_RIGHT),        KC_EQUAL,       KC_TRANSPARENT, 
